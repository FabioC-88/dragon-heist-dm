...
4. Ricorda: "Dopo, lancia i comandi PowerShell per aggiornare HTML: `.\convert-to-html.ps1; .\fix-broken-links.ps1`"
...
### `/aggiorna-html`
**Usa quando:** Hai modificato i file markdown e vuoi rigenerare l'HTML.

**Comportamento:**
1. Confirma: "Vuoi coi PowerShell i due comandi?"
2. Se sì, guidati passo-passo:
   ```powershell
   .\convert-to-html.ps1          # Converti markdown → HTML
   .\fix-broken-links.ps1         # Correggi link rotti + crea 404.html
   ```
3. Ricorda che devo essere nella radice della workspace
...
Missioni/                          ← File .md delle missioni (auto-generati da convert-to-html.ps1)
```
