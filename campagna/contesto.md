...
Le fazioni attive e i loro `folder_path` sono in `campagna/fazioni.md`.

### Arpisti — referente: Mirt · protagonista frazionale: Aelar

| # | Lv | File strutturato | Fonte grezza | Sintesi |
|---|----|-----------------|--------------|---------|
| 1 | 2 | `missioni/arpisti/M1-UnCavalloDonato.md` | `fonti/missioni/Arpisti_Missione1_UnCavalloDonato.txt` | Sorveglianza su Davil Starsong e Yagra via cavalla parlante Maxeene nel Mercato |
| 2 | 3 | `missioni/arpisti/M2-Disinfestazione.md` | `fonti/missioni/Arpisti_Missione2_Disinfestazione.txt` | Gazer di Xanathar infiltrato in una libreria del Trades Ward; salvare gatta e libri |
| 3 | 4 | `missioni/arpisti/M3-BeneventutiInFamiglia.md` | `fonti/missioni/Arpisti_Missione3_benvenuti_in_famiglia.txt` | Banda di doppelganger; valutare se sono alleabili; contatto Mattrim "Tre Corde" Mereg |
| 4 | 4 | `missioni/arpisti/M4-VeloAlzato.md` | `fonti/missioni/Arpisti_Missione4_velo_alzato.txt` | Infiltrazione sulla nave Eyecatcher durante il Giorno delle Meraviglie; prove contro Jarlaxle/Zardoz Zord |

### Force Grey — referente: Vajra Safahr · protagonisti frazionali: Razak, Vorador

| # | Lv | File strutturato | Fonte grezza | Sintesi |
|---|----|-----------------|--------------|---------|
| 1 | 2 | `missioni/forcegrey/M1-IlCaricoDelFondatore.md` | `fonti/missioni/ForceGrey_Missione1_IlCaricoDelFondatore.txt` | Recuperare un artefatto rubato legato al Giorno dei Fondatori; introduce il filo dei Cassalanters |
| 2 | 3 | `missioni/forcegrey/M2-NonETuttoOro.md` | `fonti/missioni/ForceGrey_Missione2_NonETuttoOroQuelCheLuccica.txt` | Sessione sociale/investigativa su una truffa al mercato di Waterdeep |
| 3 | 4 | `missioni/forcegrey/M3-CriminiDiPensiero.md` | `fonti/missioni/ForceGrey_Missione3_CriminiDiPensiero.txt` | Dura più sessioni (10 gg in-game); operazione sotto copertura; pianifica 3-5 sessioni |
| 4 | 5 | `missioni/forcegrey/M4-CoseTerribili.md` | `fonti/missioni/ForceGrey_Missione4_CoseTerribilidaSprecare.txt` | Assalto al covo di Xanathar; Nihiloor come boss finale |
