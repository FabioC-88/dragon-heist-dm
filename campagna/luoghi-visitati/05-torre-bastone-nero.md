...
Dall'esterno si presenta come una torre imponente, solida, senza decorazioni inutili. La magia che la permea è percepibile anche da chi non è incline al suo uso: c'è qualcosa nell'aria attorno all'edificio che suggerisce che è meglio non avvicinarsi senza una buona ragione.
...
Sede ufficiale di Force Grey / Mani Grigie. Chi viene reclutato nella fazione riceve incarichi direttamente da Vajra tramite incantesimi o messaggeri. L'accesso fisico alla torre non è per tutti. *Fonte: Dragon Heist Cap. 2 — Force Grey; Appendice B — Vajra Safahr*.
