...
## ⚠️ NOTE DI APERTURA — Stato del Mondo post-S11

**[NOTA DM — riservata]** Riepiloga prima di iniziare, e verifica con il gruppo cosa è stato effettivamente giocato in S11:

- **Dove si è fermata S11 (nucleo obbligatorio):** il party è stato arrestato fuori dalla grata delle fognature, ha attraversato l'arresto e il processo al Tribunale del Dock Ward davanti al Magistrato Umbero Zastro, e — durante il riposo in cella o subito dopo il rilascio — Golor ha finalmente sciolto la promessa fatta in S10: il Vault of Dragons si trova sotto una vecchia torre diroccata nel Sea Ward, e servono **tre chiavi** per aprirlo.
...
## 🎬 SETUP INIZIALE — Trollskull Manor, la sera dopo

> *Trollskull Manor vi accoglie con il suo consueto brusio caldo — bicchieri che tintinnano, il crepitio del focolare, la voce di Lif che intona una filastrocca sconnessa dal bancone. Fuori, il cielo estivo di Waterdeep si tinge d'arancio mentre il sole cala oltre i tetti del Sea Ward. Siete seduti al vostro tavolo abituale, la pietra — lo Stone of Golorr — avvolta in un panno al centro, silenziosa per la prima volta da giorni.*
>
> *Golor ha parlato. Avete un luogo — una torre dimenticata, in rovina, in un angolo remoto del Sea Ward — e una parola che continua a girarvi in testa: **tre chiavi**. Nessun dettaglio su cosa siano. Solo la certezza, incisa nella visione, che senza di esse le porte del Vault of Dragons non si apriranno mai.*
...
## FASE 1: LA VECCHIA TORRE — Esvele Rosznar (Sea Ward, ~35–45 min)

*[Carryover da S11 — gioca questa fase solo se non è già stata risolta. Vedi nota di apertura.]*

> *La torre si erge solitaria in un angolo dimenticato del Sea Ward — pietra grigia soffocata dall'edera, una sagoma più antica del quartiere stesso che la circonda. Non è abbandonata: davanti all'ingresso, quattro guardie in livrea attendono con la disciplina discreta di chi è pagato bene per restare immobili.*
...
All'interno, **Esvele Rosznar** è in riunione con tre rappresentanti di gilda — una formalità di rito per mettere "in regola" un edificio che non ha alcuna intenzione di sistemare per davvero:

- **Sembra Vashir** (umana calishita, Gilda dei Carpentieri, Tettai e Stuccatori)
...
- Se il party rifiuta l'accordo o tenta di scavalcarla: Esvele non minaccia apertamente, ma lascia intendere con freddezza professionale che conosce il modo di farsi sentire dalle autorità — non è un bluff.

**[NOTA DM — riservata — spotlight Vorador]** Mentre gli altri trattano con Esvele, Vorador può notare (Storia o Indagare CD 12, o semplicemente per iniziativa) che il vecchio proprietario della torre — il "mezzo dimenticato mago waterdaviano" di cui parlano tutti — compare in un registro dell'Ordine Magisti che Vorador ha consultato mesi fa, durante una delle sue ricerche su Brottor Deepdelver. Non è una pista diretta: solo un nome a margine, sottolineato dalla stessa mano di Brottor, senza spiegazione. **Non risolvere questo indizio ora** — lascialo come seme per un futuro momento di rivelazione sul caso di Brottor.

### Il Percorso verso il Vault
...
**Zelifarn:**
> *"Una scaglia è un piccolo prezzo per un'amicizia, ma anche le amicizie hanno margini. Se in fondo a questo vostro caveau nanico c'è oro — e scommetto che c'è, altrimenti perché tante chiavi — voglio il dieci per cento. È una cifra onesta, per chi vi ha salvato la pelle una volta."*

- **Se il party accetta senza discutere:** Zelifarn stacca (senza dolore visibile, con orgoglio quasi teatrale) una scaglia di bronzo dalla propria zampa e la consegna.
- **Se il party negozia:** Persuasione CD 15, oppure offerta di un tesoro dal valore di almeno 1.000 mo — riduce la sua richiesta al 5%, o la converte in un favore futuro non specificato.
- **Se Aelar è presente:** questo è il momento naturale per richiamare l'hook rimasto aperto da S9 — Aelar si era offerto di mettere in contatto Zelifarn con gli Arpisti per il festival. Se Aelar mantiene la promessa ora (anche solo verbalmente, confermando che il contatto con Remallia Haventree è ancora attivo), Zelifarn scende volentieri al 5% di richiesta, genuinamente commosso dal gesto.

**[NOTA DM — riservata]** Non serve tirare per ottenere la scaglia in sé — Zelifarn è già amico. L'unica variabile è quanto costerà.
...
## FASE 3 (SURPLUS, OPZIONALE): M2 ZENTHARIM — "TIENI IL RESTO" [carryover S9-S11]

*[Giocare solo se rimane tempo dopo la FASE 2, o come apertura di S13 se il tavolo non arriva a questo punto. Rinviata tre volte — priorità alta se il tavolo ha ancora energia questa sessione. Durata: ~60–90 min.]*

**[NOTA DM — riservata]** Come già inquadrato in S11: l'arco Oathbreaker di Krauser è già avvenuto (S9) — la scena "Proposta di Asmodeo" **non si gioca più**, è acqua passata. Il focus di questa missione si sposta su **Scintilla**: il riconoscimento della firma chimica di Rennis è inedito e potente. Per Krauser, il sigillo di Vosk non è più la scintilla che lo rompe — è la conferma silenziosa che la strada scelta è quella giusta.

**Trigger:** Il serpente volante di Davil torna al manor con il messaggio originale — Davil ha aspettato a lungo, ma non ha rinunciato al favore.

→ Per il testo completo di tutte le scene: `missioni-secondarie/zentharim/M2-TieniIlResto.md`

### Adattamento post-Oathbreaker (riassunto operativo)

**Scena 1 — Alchimia Weirdbottle:** Invariata. Skeemo Weirdbottle consegna le "pozioni". La frase *"assicuratevi che le prenda tutte e sei"* resta il momento che rivela chi è davvero Skeemo a chi presta attenzione.

**Scena 2 — Il Riconoscimento (momento centrale):**
- **Krauser:** vede il sigillo di Valerius Vosk sul salvacondotto. Da Oathbreaker, non è più shock — è conferma che Vosk è ancora protetto dalla toga di Tyr.
- **Scintilla:** riconosce automaticamente (nessun tiro) la firma chimica di Rennis nelle pozioni velenate. I reagenti sequestrati che Rennis trafficava fuori dai magazzini della Watch finivano da Skeemo, che li usava per Vosk, che copriva i Cassalanter. **Rennis era un ingranaggio in questa macchina prima di sparire** — la prima informazione concreta che Scintilla scopre sul destino del suo mentore.

**Scena 3 — Esvele Rosznar alla Statua del Cacciatore di Dei:** se la FASE 1 (Old Tower) è già stata giocata in questa stessa sessione, questa diventa un secondo incontro — Esvele riconosce subito il party (vedi dialogo in FASE 1), il tono è più diretto e meno diffidente.

**Hook aperto:** se Skeemo resta in vita (non eliminarlo — serve per l'arco), il seme per la M3 Zentharim è piantato.

**Ricompense:** 200 mo (se consegna completata), +1 Fama Zhentarim (+3 se il tradimento di Skeemo viene rivelato apertamente).
...
**[NOTA DM — riservata]** **Fermati qui.** Non descrivere l'interno del Vault, non menzionare Aurinax, non narrare V2 (l'Anticamera). Questo è deliberatamente un cliffhanger: le porte si aprono, il party vede solo buio, e la sessione si chiude sul momento di massima tensione. L'esplorazione completa del Vault of Dragons (inclusi V2-V9 e l'incontro con **Aurinax**) è materiale ricco per una sessione intera — riservalo a S13. Se il party insiste per entrare subito, è legittimo giocare qualche minuto in più, ma consiglio vivamente di tagliare sulla soglia per l'impatto narrativo.

Esvele (se presente) trattiene il fiato accanto a voi — per la prima volta da quando l'avete conosciuta, sembra genuinamente incerta.

**Esvele Rosznar:**
> *"Bene. Ora scopriamo se ne è valsa la pena."*

---

## 🧩 THREAD NARRATIVI — Setup per Sessione 13

| Hook | Fazione / PG | Stato | Note |
|------|-------------|-------|------|
| Vault of Dragons — porte aperte, interno non esplorato | Tutto il party | Attivo | S13 apre da qui: V2 Anticamera in poi, incluso Aurinax |
...
- [ ] `campagna/sessioni/dm-notes-sessione-13.md` — creare prima della prossima sessione (apre con l'esplorazione del Vault e l'incontro con Aurinax)
