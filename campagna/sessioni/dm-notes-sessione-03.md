...
>
> Quattro piani. Un torrino che sfida la gravità nell'angolo nord-est. Cinque comignoli, di cui almeno due in posizione dubbia. Tre balconi con ringhiere di ferro battuto, uno dei quali pende visibilmente verso la strada. Sopra la porta principale, uno scudo di legno fradicio reca ancora, in lettere sbiadite, il nome che fu:
>
> ***"TROLLSKULL MANOR — Tabacchi, Alcolici & Amicizie di Qualità"***
>
> Le finestre sono otturate dall'interno. Eppure, dietro una di esse, nell'oscurità, qualcosa si muove. Un'ombra che non appartiene al vento.

*[aggiunta atmosferica]*
> *I vicini che passano abbassano gli occhi — non con disprezzo, ma con quel rispetto cauto che si riserva ai luoghi che ricordano ai vivi quanto sia sottile il confine.*

**Informazioni sull'atto:**
- La proprietà è intestata legalmente al party (tutti i membri nominati)
- Nessun'ipoteca, debito o gravame pendente
- Include l'edificio principale, il seminterrato e il piccolo cortile sul retro
...
La porta principale è sbarrata dall'interno ma non bloccata magicamente. Un tiro di Atletica (CD 12) o la leva giusta la apre.

> La porta cede con un cigolio che sembra quasi protestare. Dentro, l'aria ha il sapore del tempo fermo — un amalgama di muffa, legno bruciato e qualcosa di dolciastro che potrebbe essere aceto di vino. La sala principale è un disastro: tavoli rovesciati, sedie ridotte a legna spezzata, boccali di stagno ammaccati e casse di vino svuotate di qualsiasi cosa che non fosse aceto.
>
> Lungo le pareti, scaffali reggi-boccali che nessun boccale sorregge più. Dietro il bancone, la collezione di alcolici è ridotta a etichette sbiadite e vetro infranto. Polvere ovunque — spessa abbastanza da lasciare l'impronta di ogni vostra mossa. Topi — piccoli, inoffensivi, velocissimi nel dileguarsi.
>
> Il resto dell'edificio è vuoto. Ogni stanza che ispezionate: vuota, con la sola compagnia dei ragni.

**Layout del manor:**

| Piano | Area | Condizioni |
|-------|------|------------|
| Piano terra | Taproom + Cucina | Mobilio distrutto; riutilizzabile dopo pulizia |
| Piano 1 | 4 camere da letto | Vuote; usabili con materassi di paglia |
| Piano 2 | 3 suite + sala privata | Buone condizioni strutturali; degrado superficiale |
| Piano 3 + Torrino | Vani di servizio + sommità | Pavimento instabile in un vano; torrino agibile |
| Seminterrato | Cantina + accesso fognature | Asciutto; serratura funzionante |

**Costi di ristrutturazione base:**

| Lavoro | Gilda richiesta | Costo stimato |
|--------|-----------------|---------------|
| Muri e tetto | Carpenters', Roofers' & Plaisterers' Guild | 500 mo |
| Impianti e cantina | Cellarers' & Plumbers' Guild | 250 mo |
| Arredi e bancone | Il Chiodo Storto (Tally) | 200 mo |
| Forniture mensili (cibo e birra) | Guild of Butchers + Vintners' Guild | ~50 mo/mese |

**[NOTA DM]** Non serve che il party ristrutturi *questa* sessione — basta che ne discutano e decidano la direzione. Il Capitolo 2 prevede che restino al manor per settimane prima dell'inizio del Capitolo 3.
...
Il poltergeist Lif non si manifesta immediatamente. Aspetta che il party si muova tra le stanze, poi inizia con piccoli segnali.

**Escalation progressiva:**

**Passo 1 — Dispetti (prime 5 min):**
- Un boccale ammaccato vola via da uno scaffale e si schianta sul pavimento
- Un coperchio di pentola rotola misteriosamente verso il camino spento
- La porta della cucina si chiude da sola

**Passo 2 — Messaggi (se ignorano o ridono):**

> Nella polvere spessa del pavimento della taproom, una mano invisibile traccia lentamente, lettera per lettera:
>
> **"CLOSING TIME"**
>
> Pausa. Poi, in uno spazio diverso:
>
> **"LAST CALL"**

**Passo 3 — Escalation (se continuano a ignorare o provocano):**
- Boccali volano verso le teste — tiro Destrezza CD 12 o 1d4 danni contundenti
- Le finestre si spalancano di colpo
- I topi fuggono in modo coordinato, come spinti da una paura che il party non vede

### Risoluzione: Due Percorsi

**Percorso A — Appeasement (raccomandato)**

Se il party dimostra intenzione di ristrutturare la taverna e riaprirla al pubblico, Lif inizia ad accettarli.

> La polvere sul pavimento si cancella da sola. In caratteri più puliti, quasi eleganti, appare:
>
> *"Allora avete capito."*
>
> Pausa. Poi, sotto:
>
> *"Questo posto ha bisogno di qualcuno che ci tenga."*

Dopo questo momento, Lif non è più ostile. Apre porte, sposta oggetti, aiuta in silenzio. È il barista di questa taverna — sarà sempre tale, anche da morto.

**Percorso B — Combattimento (se attaccano)**
...
*Indizio sottile, non da spingere. Solo un filo aperto.*
...
*Una battuta da pronunciare senza enfasi, come se nulla fosse:*
> *"La vera saggezza non è fare sempre la cosa giusta. È sapere quando le regole non si applicano a te."*
...
### XP / Milestone
- **Milestone:** Completamento Cap. 1 → Lv 2 (da dare a inizio sessione o già dato a fine S2)
...
- [ ] Aggiornare `Campagna/party.md` — stato PG post-S3 (Lv 2 confermato; nuovi PNG)
