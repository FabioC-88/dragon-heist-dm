...
**Il party sa ora:**
1. ✓ Volo Geddarm ha perso il suo amico Floon Blagmaar
2. ✓ Floon è scomparso dopo una serata al Drago Infilzato nel Dock Ward (due notti fa)
3. ✓ Volo offre 100 gp alla consegna di Floon sano e salvo (anticipati 10 gp a testa)
4. ✓ Nel Portale Spalancato era in corso una faida tra la Gilda di Xanathar e gli Zhentarim

### PNG Incontrati / Stato

| PNG | Stato | Note |
|-----|-------|------|
| Durnan | Neutrale / Rispettoso | Ha combattuto il troll; rispetta chi ha combattuto al suo fianco |
| Yagra Stonefist | Neutrale | Zhentarim; salvata dal brawl; non ha ringraziato, ma ha notato |
| Volo Geddarm | Amichevole (+2) | Quest-giver; preoccupato per Floon; ha anticipato 10 gp |
| Krentz | Fuggito o neutralizzato | Leader banditi Xanathar durante il brawl |
...
- **Immediato:** Trovare Floon Blagmaar — possibili punti di partenza suggeriti da Volo: Vecchio Xoblob, Drago Infilzato
- **Lungo termine:** Chi ha rapito Floon e perché?

### Fazioni — Status Post-Sessione

| Fazione | Status | Note |
|---------|--------|------|
| **Gilda di Xanathar** | Ostile latente | Banditi Xanathar sconfitti al brawl |
| **Zentharim** | Neutri | Yagra è Zhentarim; aiutata dal party |
| **Guardia Cittadina** | Neutra | Non coinvolta |
| **Force Grey** | Non ingaggiati | — |
| **Arpisti** | Non ingaggiati | — |

---

## ✅ POST-SESSION CHECKLIST

- [ ] Aggiorna `campagna/party.md` — nessun level up; annotare 10 gp a testa ricevuti da Volo
- [ ] Aggiorna `campagna/png-incontrati.md` — aggiungi Durnan (Neutrale/Rispettoso), Yagra (Neutrale), Volo (+2), Krentz (fuggito/sconfitto)
- [ ] **Nota:** La Fase 4 (Indagine nel Quartiere del Porto) è stata spostata integralmente in `dm-notes-sessione-02.md`
