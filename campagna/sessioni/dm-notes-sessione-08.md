...
> **Durata stimata:** ~2h. **Zentharim M2 è surplus pianificato:** se Villa + FASE 2 riempiono la serata, M2 scivola interamente a S9 senza problemi. Prep abbondante per garantire continuità al tavolo.
> **XP accumulati:** Milestone — Lv 3. **Nessun level up in S8:** il **Lv 4** scatta alla chiusura del Cap. 3, dopo le tre missioni M2 (~S9-S11).

---

## ⚠️ NOTE DI APERTURA — Stato del Mondo post-S7

**[NOTA DM — riservata]** Riepiloga prima di iniziare:

- **Dove si è fermata S7:** Il party ha sconfitto i cani nel cortile (G2) e i due thug nella sala da pranzo (G8). È salito al piano di sopra. Si trova nell'atrio superiore, prima dell'atrio di combattimento (G13). La sessione si è interrotta qui.
- **Nimblewright:** Il Detector è acceso — il nimblewright è da qualche parte nella villa. Ancora presente al piano superiore (non fuggito, per ora).
- **Nella villa in questo momento:** Guerra civile in corso — gli Zhentarim hanno il piano terra (ora parzialmente sgomberato dal party), i Gralhund tengono il piano superiore. Urstul Floxin è vivo (ferito, 50 PF, G15a) e sta tentando di sfondare la porta di G15b per catturare Lord Orond.
- **Davil Starsong:** Arrestato per interrogatorio dalla Watch (nessuna accusa formale — lo rilascerà entro sera). Il rastrellamento Zhentarim post-Fireball è al culmine. Messaggio di Davil per Krauser/Scintilla atteso entro fine sessione.
- **Renaer Neverember:** Ha promesso di raccogliere informazioni su Urstul/Villa Gralhund. Il rapporto potrebbe arrivare a fine sessione — ma la villa è già stata trovata per altra via.

---

## 🎬 SETUP INIZIALE — Il Piano di Sopra

### Apertura Sessione

> L'atrio superiore della villa è immerso in un silenzio che non mente. Dagli spigoli della porta in fondo — quella con le incerature di legno pregiato sfondate a metà — filtrano rumori di scontro smorzato: passi pesanti, un oggetto che cade, una voce che insulta in un accento straniero.
>
> Il Detector ha smesso di frullare da quando siete entrati. Qualunque cosa stiate cercando, è ancora qui dentro.

**[NOTA DM — riservata]** Il Detector punta verso G16 (nimblewright nella camera padronale di Yalah). La distanza è inferiore a 9 m — l'ombrello ruota al massimo. Quando il party avanza verso G13, il Detector accelera visibilmente.
...
**Loot G13 (cadaveri):** 3d6 mo per veterano Gralhund (armatura), niente di speciale sugli Zhent.
...
**Urstul Floxin** — sicario Zhentarim, ferito.

> *Tall, his black hair worn in a topknot and his face masked by a black veil, Urstul Floxin has a crocodile tattoo on one forearm and a spider tattoo on the other.*

**[NOTA DM — riservata]** Urstul è determinato a catturare Lord Orond come merce di scambio per recuperare lo Stone of Golorr. Non sa che Yalah ha già consegnato la pietra al nimblewright. Se il party lo interrompe, valuta la situazione: se in svantaggio, tenta la fuga verso la scala che scende al piano terra (sbucando fuori dalla villa — la Watch non è ancora arrivata). Se intrappolato, combatte.

**Statblock Urstul Floxin (ferito)**
- GS 3, **50 PF**, CA 14 (armatura di cuoio)
- **Niente veleno sulle armi** (è ferito da ieri — non è al meglio)
- Azioni: Attacco Scimitarra +5, 1d6+3 tagl. | Attacco Pugnale +5, 1d4+3 perfor.
- **Assassinate (1 round/riposo):** se colpisce con vantaggio al primo round (sorpresa o occultamento), il danno è massimizzato.
- Se catturato/interrogato: sa dove si trovano gli Zhentarim a Waterdeep (alcune safe house), conosce il nome di **Manshoon** come suo "padrone" — non lo rivela volontariamente, ma se magicamente costretto potrebbe cedere.

**[NOTA DM — Hook Barnabus]** Urstul Floxin era qui. Questa è la seconda volta che potrebbe scivolare tra le dita di Barney. Se Barney riesce a catturarlo o ucciderlo, è la chiusura (parziale) di un arco personale. Se Urstul fugge ancora: Barney ha visto la sua faccia da vicino — tornerà.
...
> Uno studio rivestito di libri che nessuno legge. Al centro del pavimento, un cerchio di rune argentate inciso nella pietra — un simbolo di teletrasporto permanente, abbastanza ampio da contenere due persone. Sull'angolo del cerchio, una nota staccata in un numero di copie non specificato.
>
> Seduto dietro la scrivania, Lord Orond Gralhund: un uomo sulla cinquantina con gli occhi di chi sa di aver perso già prima che tu apra la porta.

**Lord Orond Gralhund** — codardo, si arrende al primo intruso credibile.

Se pressato con Intimidazione (CD 10, svantaggio se teme che Yalah possa sentire):
...
**[NOTA DM — riservata]** Il cerchio di teletrasporto porta alle **Kolat Towers**. Manshoon lo usava per le riunioni private con i Gralhund. Il party non conosce la destinazione — né lo sa Orond (è sempre stato condotto bendato). Se qualcuno usa il cerchio: atterra in una stanza di transito alle Kolat Towers, sorvegliata da 2 Blade dei Manshoon. Suggerisci: esaminare le rune (Arcana CD 16 per capire che è un punto fisso — chi sa il nome della destinazione lo può attivare; altrimenti non funziona senza la parola di comando).
...
**Lady Yalah Gralhund** — Nobildonna LE. Fredda, protocollo impeccabile sotto pressione, mentirebbe mentre brucia.

**Hrabbaz** — Mezzorco guardaspalle. GS 4, 65 PF, CA 14 (pelle spessa). Si interpone tra Yalah e chiunque minacci lei. Si ritira solo se Yalah lo ordina o se si trova sotto Lv 3 PF.

**[NOTA DM — riservata]** Il nimblewright **è già fuggito dalla villa** con lo Stone of Golorr mentre il party era al piano terra. Yalah finge ignoranza su dove sia andato. Se il Detector è acceso: **smette di girare** non appena il party entra in G16. Il nimblewright non c'è più. Questo è il momento in cui il party capisce che è sfuggito. Yalah può essere intimidita (Intimidazione CD 15) a rivelare che "il mio servo è uscito" — ma non la direzione, perché davvero non lo sa. L'ha mandato con una mappa; il costrutto scelglie autonomamente il nascondiglio.

**Se la situazione precipita e Hrabbaz cade:** Yalah si chiude nella stanza dei bambini (G18) per un'ultima resistenza. Se catturata: implora pietà in nome dei figli, non rivela nulla di Asmodeo.
...
- **Due vesti rosse e oro** — mantelli cerimoniali con lo stemma di un sigillo in forma di bilancia infuocata.

Questo è il riscontro del talismano di Vorador, inerte da S5. Il sigillo che compare su questi due simboli è lo **stesso** che Vorador ha trovato sul cadavere del cultista mesi fa. Per Vorador: **riconoscimento automatico** — nessun tiro.

**[NOTA DM — Hook Vorador]** Non spiegare il quadro completo. Lasciare che Vorador colleghi i punti: il sigillo che nessun accademico sapeva identificare, è qui, nel baule di una nobildonna che ha appena cercato di rubare un artefatto miliardario. La connessione con i Cassalanters non si rivela ancora.
...
| Dove | Oggetto |
|------|---------|
| G3 — Rimessa (cavallo Maladar) | *Horseshoes of speed* + 2 bisacce con 4 lingotti d'oro da 250 mo cad. = **2.000 mo in lingotti** |
| G7 — Lavanderia (cadavere governante) | Mazzo di chiavi per tutte le porte e armadi della magione |
| G16 — Baule di Yalah | 2 simboli sacri di Asmodeo + 2 vesti rosse e oro *(prove/filo, non vendibili senza domande)* |
| G15b — Studio | Tomo genealogico dei Gralhund (valore 50 mo se venduto; non si vende senza domande) |
...
Chi viene visto allontanarsi dalla scena diventa sospetto. Se il party ha ucciso un membro dei Gralhund lasciando testimoni o prove, Barnibus ordina a Cromley di **arrestarlo per omicidio di un nobile** (pena di morte). L'uscita dalla villa conta quanto l'entrata.

**[NOTA DM — Hook Barnabus]** Barnibus sa che Urstul era qui. Se il party lo ha catturato o ucciso, Barnibus vuole il resoconto. Se Urstul è fuggito di nuovo: è la seconda beffa in due giorni.
...
- Le testimonianze e il Nimblewright Detector (ora taciturno)
- Le informazioni di Renaer su Dalakhar e Stone of Golorr
- Le rivelazioni di Lord Orond (se interrogato) sull'origine della Fireball
...
- Per Vorador: il sigillo di Asmodeo nel baule = i fili iniziano a convergere
- Per Barnabus: Urstul era qui — catturato / fuggito / ucciso

Sul selciato di Trollskull Alley restano ancora le macchie scure dell'esplosione. Lif ha collocato un fiore sul bancone. Maestro Bec giudica tutto in silenzio dal bordo del bancone.
...
**[NOTA DM]** Niente confronto pendente: Emmek resta un filo aperto, non una scena obbligata. Il rapporto serve a tenere caldo il thread e, all'occorrenza, a riagganciare l'arco wererat/Zhentarim più avanti. Usa come colore o accantona se la serata è piena.
...
**[NOTA DM — riservata]** Il nome **Istrid Horn** non è nuovo: in S6 i PG hanno scoperto che aveva prestato 150 mo a Emmek Frewn. Ora Istrid ha un problema più grande: dopo la Fireball e la Gralhund Villa Bloodbath, la Watch sta rastrellando ogni membro Zhentarim noto, incluso **Davil**, portato in caserma per interrogatorio. Istrid non era coinvolta, ma teme che l'indagine esponga la sua operazione di prestiti illegali.
...
**Rischio se la tradiscono:** Istrid contatta un altro membro dei Doom Raiders, che inizia a sabotare la reputazione del manor (clienti spaventati, fornitura complicata). Non attacca direttamente — la legge di Waterdeep la vincola.
...
**Trigger:** La sera, al Portale Spalancato. Soprattutto se Krauser è entrato a Villa Gralhund e ha visto i simboli di Asmodeo nel baule di Lady Gralhund: torna con una domanda che non riesce a posare. Aldric è al solito posto al bancone e gli spinge davanti una birra senza che l'abbia chiesta.
...
**Dove paga:** La rivelazione completa + la proposta + la svolta Oathbreaker arrivano **durante/dopo la Zentharim M2 "Tieni il Resto"**, quando Krauser riconosce il sigillo di Valerius Vosk sulle pozioni e la ferita si riapre a sangue caldo. Scena completa in `missioni-secondarie/zentharim/M2-TieniIlResto.md` → sezione *"La Proposta di Asmodeo"*.
...
- **Zentharim — Davil Starsong → "Tieni il Resto" (~S8-S9, prima M2).** Quando il rastrellamento si placa e Davil esce dalla caserma, manda a Krauser/Scintilla un biglietto asciutto: *"Devo recuperare il tempo perso. Un lavoro semplice — una consegna. Passate al Portale quando potete."* È l'aggancio di "Tieni il Resto" (consegna di pozioni; introduce Skeemo Weirdbottle, nodo della rete Rennis/Manshoon). Apre l'arco Oathbreaker di Krauser. **Da giocare per prima tra le M2.**
- **Force Grey — Vajra Safahr → "Non è Tutto Oro" (~S9).** Vajra convoca i membri Force Grey alla Torre del Bastone Nero. Un *sending* o un messo: *"Una questione al porto navale richiede mani fidate. E ho qualcosa da mostrarti sull'ufficio di Brottor."* È l'aggancio della missione "sociale" (giovane drago di bronzo nel porto).
- **Arpisti — Mirt → "Disinfestazione" (~S9-10).** Mirt fa pervenire ad Aelar (uccellino origami) una richiesta defilata: *"Una libreria amica nel Trades Ward — Curiosity & Satisfaction — ha un problema con un... ospite occhiuto. Discrezione, come sempre."* È la M2 Arpisti (Gazer di Xanathar). Da giocare per ultima tra le M2.

**[NOTA DM]** Piano M2 concordato: le tre M2 sono **interlacciate** durante il Cap. 3, una per sessione (~2h), come filo serale accanto alla trama principale. Ordine: Zhentarim → Force Grey → Arpisti. **Level up a Lv 4** alla chiusura del Cap. 3, dopo tutte e tre.
...
>
> **Prerequisito:** Davil è uscito dalla caserma. Il messaggio è già arrivato (seminato in FASE 2). Il party ha risposto o passa direttamente al Portale Spalancato.

### Il Messaggio di Davil

Un serpente volante deposita una pergamena, firmata in modo informale:
...
**[NOTA DM — riservata]** Nessuna firma esplicita di Davil — tipico Zhentarim, operatività sporca. Il tono è di Davil che vuole "recuperare il tempo perso" dopo il rastrellamento. Il party viene mandato a eseguire una consegna innocente. Non lo è.
...
**Esvele Rosznar** — "La Vipera Nera". Ladra storica creduta morta. Ancora viva, pianifica un colpo a Villa Cassalanter.

**Prove chiave:**
| Azione | CD | Caratteristica | Risultato |
|--------|-----|-----------|-----------|
| Riconoscere il veleno | 13 | Arcana / Alchimia | Scopri l'inganno di Skeemo |
| Resistere a Suggestione di Skeemo | 13 | Salvezza Sag | Non sei controllato |
...
### La Proposta di Asmodeo — Krauser (dopo M2)

**[NOTA DM]** Questa scena si gioca **la sera stessa di M2**, quando il riconoscimento del sigillo di Vosk ha riaperto la ferita a sangue caldo. È una scena uno-contro-uno — ritaglia uno spazio separato. Per il testo completo, gli obiettivi e le meccaniche Oathbreaker: vedi `missioni-secondarie/zentharim/M2-TieniIlResto.md` → sezione *"La Proposta di Asmodeo"*.

**Il cuore della scena in breve:** Aldric rivela di essere il "vecchio conoscente" della Shadowfell. Non mente mai. Offre giustizia senza porte sul retro. Non chiede un'anima stasera — solo che Krauser smetta di mentirsi su Tyr. Il prezzo verrà dopo. La scelta è nelle mani di Gabri.
...
## ⚠️ NOTA DM — Il Quadro d'Insieme (Riservata)

**[NOTA DM — riservata]** Con S8 i fili del Cap. 3 si chiudono e i semi del Cap. 4 si aprono:

- **Lo Stone è fuggito** — il nimblewright lo ha nascosto a Waterdeep. La caccia alla pietra (Cap. 4) può iniziare dalle prossime sessioni.
- **Vorador e il baule di Asmodeo** — il sigillo del talismano e i simboli Cassalanter sono stati connessi. Non ancora un'accusa, ma una certezza.
- **Krauser** — se la svolta Oathbreaker avviene in S8, è il momento narrativo più importante della campagna fino a qui. Se slitta a S9, il seme è piantato.
- **Scintilla e Rennis** — la firma chimica di Rennis su quelle pozioni è la prima prova concreta. Lei sa. Quanto tempo passerà prima che capiti l'occasione di cercarlo?
- **Esvele Rosznar** — se sopravvive, è un contatto prezioso per il finale con i Cassalanters.

---

## 🧩 THREAD NARRATIVI — Sessione 8
...
| Lord Gralhund interrogato | Tutti | **FASE 1** | Tre rivelazioni sull'origine della Fireball |
| Rapporto Vincent Trench | Tutti | **FASE 2** | Filo Emmek — colore, non obbligo |
| Messaggio di Istrid Horn | Krauser, Scintilla | **FASE 2** | Rifugio al manor → +2 Renown Zhentarim |
| Krauser/Aldric — Prima Crepa | Krauser | **FASE 2** | Seme Oathbreaker; paga in M2 |
| Zentharim M2 — "Tieni il Resto" | Krauser, Scintilla | **FASE 3** | Skeemo/pozioni/Esvele; svolta Oathbreaker |
| Scintilla riconosce firma di Rennis | Scintilla | **FASE 3** | Prima prova concreta che Rennis era nella catena di Manshoon |
| Force Grey M2 — semina "Non è Tutto Oro" | Vorador, Razak | **Semina S8** | Vajra convoca; ~S9 |
| Arpisti M2 — semina "Disinfestazione" | Aelar | **Semina S8** | Mirt via origami; ~S9-10 |
