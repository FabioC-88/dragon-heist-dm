# Contesto Campagna — Waterdeep: Dragon Heist

> Questo file contiene tutte le informazioni specifiche della campagna corrente.
> Aggiorna dopo ogni sessione rilevante. Consultato da tutti gli agenti come fonte di verità sul mondo.
...
| **Hlam** | Monaco del Monte Waterdeep; oracolo sporadico | Prima dell'inizio (BG Mirko) | Indipendente |
...
Le fonti grezze sono in `fonti/missioni/`. I file strutturati sono in `missioni/{fazione}/`.
Le fazioni attive e i loro `folder_path` sono in `ai/knowledge/fazioni.md`.

### Arpisti — referente: Mirt · protagonista frazionale: Aelar

| # | Lv | File strutturato | Fonte grezza | Sintesi |
|---|----|-----------------|--------------|---------|
| 1 | 2 | `missioni-secondarie/arpisti/M1-UnCavalloDonato.md` | `fonti/missioni/Arpisti_Missione1_UnCavalloDonato.txt` | Sorveglianza su Davil Starsong e Yagra via cavalla parlante Maxeene nel Mercato |
| 2 | 3 | `missioni-secondarie/arpisti/M2-Disinfestazione.md` | `fonti/missioni/Arpisti_Missione2_Disinfestazione.txt` | Gazer di Xanathar infiltrato in una libreria del Trades Ward; salvare gatta e libri |
| 3 | 4 | `missioni-secondarie/arpisti/M3-BeneventutiInFamiglia.md` | `fonti/missioni/Arpisti_Missione3_benvenuti_in_famiglia.txt` | Banda di doppelganger; valutare se sono alleabili; contatto Mattrim "Tre Corde" Mereg |
| 4 | 4 | `missioni-secondarie/arpisti/M4-VeloAlzato.md` | `fonti/missioni/Arpisti_Missione4_velo_alzato.txt` | Infiltrazione sulla nave Eyecatcher durante il Giorno delle Meraviglie; prove contro Jarlaxle/Zardoz Zord |

### Force Grey — referente: Vajra Safahr · protagonisti frazionali: Razak, Vorador

| # | Lv | File strutturato | Fonte grezza | Sintesi |
|---|----|-----------------|--------------|---------|
| 1 | 2 | `missioni-secondarie/forcegrey/M1-IlCaricoDelFondatore.md` | `fonti/missioni/ForceGrey_Missione1_IlCaricoDelFondatore.txt` | Recuperare un artefatto rubato legato al Giorno dei Fondatori; introduce il filo dei Cassalanters |
| 2 | 3 | `missioni-secondarie/forcegrey/M2-NonETuttoOro.md` | `fonti/missioni/ForceGrey_Missione2_NonETuttoOroQuelCheLuccica.txt` | Sessione sociale/investigativa su una truffa al mercato di Waterdeep |
| 3 | 4 | `missioni-secondarie/forcegrey/M3-CriminiDiPensiero.md` | `fonti/missioni/ForceGrey_Missione3_CriminiDiPensiero.txt` | Dura più sessioni (10 gg in-game); operazione sotto copertura; pianifica 3-5 sessioni |
| 4 | 5 | `missioni-secondarie/forcegrey/M4-CoseTerribili.md` | `fonti/missioni/ForceGrey_Missione4_CoseTerribilidaSprecare.txt` | Assalto al covo di Xanathar; Nihiloor come boss finale |

### Zentharim — referente: Davil Starsong · protagonisti frazionali: Friedrich, Scintilla

| # | Lv | File strutturato | Fonte grezza | Sintesi |
|---|----|-----------------|--------------|---------|
| 1 | 2 | `missioni-secondarie/zentharim/M1-UnBruttoMomento.md` | `fonti/missioni/Zentharim_Missione1_un_brutto_momento.txt` | Primo contatto ufficiale con Davil e Yagra; introduzione alla rete nera |
| 2 | 3 | `missioni-secondarie/zentharim/M2-TieniIlResto.md` | `fonti/missioni/Zentharim_Missione2_tieni_il_resto.txt` | Introduce Skeemo — funge da distrattore e prova che il magistrato lo usava per coprire i suoi crimini |
...
| 4 | 4 | `missioni-secondarie/zentharim/M3-CorriDasher.md` | `fonti/missioni/Zentharim_Missione3_corri_dasher.txt` | Tono investigativo + umano; famiglia Snobeedle |
| 5 | 5 | `missioni-secondarie/zentharim/M4-SangueDeiPatto.md` | `fonti/missioni/Zentharim_Missione4_sangue_del_patto.txt` | **Regolamento di conti**: Friedrich affronta il magistrato (o lo smaschera/elimina). Skeemo può essere un boss finale alternativo. |
