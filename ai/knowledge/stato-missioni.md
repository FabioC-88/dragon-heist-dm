# Missioni Secondarie — Waterdeep: Dragon Heist

> Traccia lo stato delle 12 missioni scritte. Aggiorna dopo ogni sessione.
>
> **Stato:** `Pianificata` · `In corso` · `Completata` · `Saltata`
>
> Per i dettagli completi di ogni missione, apri il file `.txt` corrispondente nella workspace.
> Per espandere una missione con materiale aggiuntivo, usa `/espandi-missione` in chat.
...
Referente: **Mirt il Cambiavalute** · Protagonista frazionale: **Aelar Moonwhisper**
...
| 2 | Disinfestazione | 3 | `Arpisti_Missione2_Disinfestazione.txt` | [📖 Leggi](../Missioni/Arpisti/M2-Disinfestazione.md) | `Pianificata` *(S8: ricezione messaggio Mirt, posticipata a ~S9-10)* |
...
### Note per il DM — Arpisti

- **M1** introduce Davil Starsong e Yagra come PNG rilevanti *anche* per le missioni Zhentarim — giocala prima della Zhentarim M1 se possibile
- **M2** richiede la libreria *Curiosity & Satisfaction* nel Trades Ward e la taverna *Felzoun's Folly* come location chiave
- **M3** usa un uccellino di carta magico come messaggero — momento narrativo che può introdurre un PNG doppelganger di colore
- **M4** dipende dall'arco di Jarlaxle/Eyecatcher; giocarla quando il party ha già sentito parlare di Zardoz Zord
...
| 2 | Non è Tutto Oro Quel che Luccica | 3 | `ForceGrey_Missione2_NonETuttoOroQuelCheLuccica.txt` | [📖 Leggi](../Missioni/ForceGrey/M2-NonETuttoOro.md) | `Pianificata` *(S8: ricezione convocazione, posticipata a ~S9)* |
...
| 2 | Tieni il Resto | 3 | `Zentharim_Missione2_tieni_il_resto.txt` | [📖 Leggi](../Missioni/Zentharim/M2-TieniIlResto.md) | `Pianificata` *(S8: surplus non giocato, slitta a S9 — apre arco Oathbreaker Krauser)* |
...
> Ordine suggerito per alternare le missioni in modo equilibrato tra le fazioni:
